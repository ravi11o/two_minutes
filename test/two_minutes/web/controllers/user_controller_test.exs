defmodule TwoMinutes.Web.UserControllerTest do
  use TwoMinutes.Web.ConnCase

  alias TwoMinutes.Account

  @create_attrs %{avatar: "some avatar", email: "some email", hashed_password: "some hashed_password", is_admin: true, name: "some name", provider: "some provider", verified: true}
